...
const EditClient = ({ setIsViewMode, setIsEditMode }) => {
    ...
    useEffect(() => {
        const getResult = async () => {
            ...
            try {
                const referenceResponse = await searchService.getClient(id);
                setClientData(referenceResponse);
                setClient(referenceResponse);
            } catch (error) {
                setError(
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await searchService.putClient(client.id, dataToSend);
            setIsEditMode(false);
            setIsViewMode(true);
            location.reload();
        } catch (err) {
                ...
                <>
                    <section className="sb__navbar-section">
                        <div className="sb__container">
                            <h1 className="sb__text">Редактирование данных Клиента</h1>
                        </div>
                        <hr />
                    </section>
